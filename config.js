...
module.exports = {
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://Bikash:Bikashop@bikash.cbkkx4c.mongodb.net/?retryWrites=true&w=majority",
    sessionId: process.env.SESSION_ID || "palDLsk1C_A_N_Y_A_V_2_dkWNLTdFgVh",
